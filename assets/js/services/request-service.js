...
// Hyperlink fields ที่ SharePoint จำกัด 255 ตัวอักษร
// dwgFileUrl และ pdfFileUrl ถูกถอดออกจากนี้แล้ว
// เพราะ SharePoint Drive URL มักยาวกว่า 255 ตัวอักษร
// ให้เก็บเป็น plain text แทน (ต้องเปลี่ยน Column ใน SharePoint เป็น Multiple lines of text)
const HYPERLINK_LOCAL_KEYS = new Set(["dataLink"]);
