...
export async function adminCancel(request, reason) {
  // เก็บ "สถานะ ณ ตอนยกเลิก" + "ผู้ที่กดยกเลิก" ไว้ใช้คำนวณ Cancellation KPI
  // → ยกเลิกก่อนเริ่มเขียนงานจริง (pending / inprogress_lv1) จะไม่ถูกนำมาคิด Cancellation Rate
