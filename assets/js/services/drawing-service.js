...
export async function uploadSendworkFiles(request, files = [], reviseTag = "", onProgress = null) {
  ...
  // ── ชื่อโฟลเดอร์ใช้ DrawingNo-DrawingName-Revise (แยกแต่ละ revision) ──
  // ── ชื่อไฟล์ใช้ DrawingNo-DrawingName (ตาม spec) ──
  // ── fallback: ถ้าไม่มี drawingNo/drawingName ให้ใช้ชื่อไฟล์เดิม (ไม่ใช่ชื่อว่าง) ──
