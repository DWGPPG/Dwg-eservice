  ...
  return `
    <tr>
      ...
      <td style="white-space:nowrap;">
        ...
        <button class="small-button secondary-button" style="margin-top:4px;" data-pickup-reject-toggle="${escapeHtml(item.requestNo)}" type="button">↩️ ตีกลับ</button>
      </td>
    </tr>
    <tr id="pickup-reject-row-${escapeHtml(item.requestNo)}" hidden>
      <td colspan="9" style="background:#FFFBEB;padding:12px 16px;">
