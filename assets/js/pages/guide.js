...
const tocItems = [
  ...
  { id: "revision", label: "การแก้ไข (Revise) & เหตุผล" },
  { id: "kpi", label: "KPI & การวัดผล" },
...
const workflowSteps = [
  {
    ...
    owner: "ผู้ร้องขอ",
    text: "เริ่มต้นด้วยการ <strong>เลือกประเภทงานก่อนเสมอ</strong> (Proposal / ขออนุญาต / ก่อสร้าง / As-Built / อื่นๆ) — ส่วนโครงการและ Drawing จะปรากฏขึ้นมาให้กรอกหลังเลือกประเภทงานแล้วเท่านั้น จากนั้นเลือกโครงการ ติ๊ก Drawing ที่ต้องการ (เลือกได้หลายรายการพร้อมกัน) ระบุวันที่ต้องการรับงาน ความเร่งด่วน และแนบไฟล์/ลิงก์อ้างอิง ระบบจะออกเลขคำร้องให้อัตโนมัติ — ถ้าเลือกโครงการเดิมที่เคยมีอยู่แล้ว ระบบจะดึงข้อมูล Drawing เดิมมาแสดงให้ดูด้วย",
  },
  {
    number: "2",
    title: "รับงาน (Lv.1)",
    owner: "ฝ่ายเขียนแบบ (Lv.1)",
    text: "สมาชิกในฝ่ายเขียนแบบเปิดหน้า \u201cรับงาน / อนุมัติ\u201d เลือกงานที่ต้องการรับผิดชอบได้ทีละรายการ หรือติ๊กเลือกหลายรายการพร้อมกันแล้วกดปุ่ม \u201cรับงาน\u201d ครั้งเดียว คำร้องจะเปลี่ยนเป็นสถานะ \u201cรอ LV.2 ผู้จัดการอนุมัติ\u201d ทันที",
  },
  {
    number: "3",
  ...
  },
  {
    ...
    owner: "ผู้รับผิดชอบ",
    text: "เลือก \u201c\u2705 เสร็จสิ้น\u201d จากช่องสถานะเพื่อเปิดหน้าต่างส่งมอบงาน ใส่ลิงก์ DWG/PDF หรือแนบไฟล์ได้ทุกประเภท (.dwg, .pdf, .jpg, .png, .docx, .xlsx, .zip ฯลฯ) — ไฟล์ DWG/PDF จะถูกลิงก์ตรงในระบบ ส่วนไฟล์ประเภทอื่นจะแสดงเป็นปุ่มให้ผู้จัดการกดเปิดได้ทันที ระบุ Revise และหมายเหตุ — เมื่อกดยืนยัน งานจะเข้าสู่สถานะ \u201cรอผู้จัดการตรวจ+ส่งมอบ\u201d สถานะในหน้าติดตามงานจะอัปเดตทันทีโดยไม่ต้องรีเฟรช และระบบแจ้ง Teams ไปยังผู้จัดการ Lv.2 ทุกคนทันที",
  },
  {
    number: "6",
    title: "ผู้จัดการตรวจสอบและส่งมอบ",
    owner: "ผู้จัดการ (Lv.2)",
    text: "เปิดหน้า \u201cรับงาน / อนุมัติ\u201d ส่วน \u201cตรวจสอบและส่งมอบงาน\u201d — การ์ดแต่ละใบจะแสดงไฟล์งานครบ ได้แก่ ปุ่ม 📐 DWG, 📄 PDF, ปุ่มไฟล์ 📎 ประเภทอื่นๆ, 🔗 ลิงก์อ้างอิง และปุ่ม 📁 เปิดโฟลเดอร์ทั้งหมด (ลิงก์ตรงไป SharePoint) กด \u2705 อนุมัติ + ส่งมอบ เพื่อแจ้งผู้ร้องขอทันที (Teams + Email) หรือ \u21a9\ufe0f ส่งกลับแก้ไข พร้อมระบุเหตุผลให้ผู้รับผิดชอบแก้ไขแล้วเลือก \u201c\u2705 เสร็จสิ้น\u201d ส่งใหม่อีกครั้ง",
  },
  {
    number: "7",
...
const roleRows = [
  ...
  { role: "ฝ่ายเขียนแบบ Lv.1", cond: "อีเมลอยู่ในรายชื่อสมาชิกฝ่ายเขียนแบบ", access: "ภาพรวม, ส่งคำร้อง, ติดตามงาน, รับงาน/อนุมัติ, คู่มือ" },
...
function renderRevisionSection() {
  return `
    <section class="guide-section" id="guide-revision">
      <div class="guide-section-heading">
        <span>Revision</span>
        <h3>การแก้ไขงาน (Revise) และการระบุเหตุผล</h3>
      </div>
      <p>เมื่อผู้ร้องขอส่งคำร้อง Revision ครั้งที่ 2 ขึ้นไป ระบบจะแสดงช่อง <strong>เหตุผลการแก้ไข</strong> บังคับให้ระบุก่อนส่ง เพื่อนำมาคำนวณ KPI ที่เป็นธรรมต่อทุกฝ่าย</p>
      <div class="guide-storage-rules">
        <div class="guide-rule">
          <b>1.1 ความผิดพลาดจากฝ่ายเขียนแบบ</b>
          <p>เช่น คำผิด ใส่รายละเอียดไม่ครบตามคำขอ — <strong>กระทบ Drawing Quality Score</strong><br>
          ต้องแนบหลักฐานและระบุเหตุผล หากฝ่ายเขียนแบบตรวจสอบแล้วไม่พบความสอดคล้อง จะยกเลิกคำขอทันที</p>
        </div>
        <div class="guide-rule">
          <b>1.2 ความผิดพลาดจากผู้ส่งคำร้อง</b>
          <p>เช่น ข้อมูล Spec ที่ส่งมาไม่ครบ เปลี่ยนความต้องการ — <strong>ไม่กระทบ KPI ฝ่ายเขียนแบบ</strong></p>
        </div>
        <div class="guide-rule">
          <b>1.3 ความผิดพลาดจากงานติดตั้งโครงการ</b>
          <p>เช่น หน้างานสั่งเปลี่ยนแปลงหลังเริ่มติดตั้ง — <strong>ไม่กระทบ KPI ฝ่ายเขียนแบบ</strong></p>
        </div>
        <div class="guide-rule">
          <b>1.4 ความผิดพลาดจากลูกค้า</b>
          <p>เช่น ลูกค้าเปลี่ยนแบบ เพิ่ม Scope กลางทาง — <strong>ไม่กระทบ KPI ฝ่ายเขียนแบบ</strong></p>
        </div>
      </div>
    </section>
  `;
...
function renderKpiSection() {
  return `
    <section class="guide-section" id="guide-kpi">
      <div class="guide-section-heading">
        <span>KPI</span>
        <h3>KPI & การวัดผลประสิทธิภาพฝ่ายเขียนแบบ</h3>
      </div>
      <p>KPI ทั้งหมดแสดงที่หน้า <strong>01 ภาพรวม</strong> กรองได้ตาม ฝ่าย/รายบุคคล และช่วงเวลา</p>
      <div class="guide-storage-rules">
        <div class="guide-rule">
          <b>🏆 Drawing Quality Score</b>
          <p><strong>วิธีคิด:</strong> วัดเฉพาะ Revision ที่มีสาเหตุ 1.1 (ฝ่ายเขียนแบบ) เท่านั้น<br>
          • แก้ไข &lt; 4 ครั้ง = 100 คะแนน (ปรับปรุงได้ในระดับปกติ)<br>
          • แก้ไข ≥ 4 ครั้ง = 20 คะแนน (ปัญหาซ้ำซาก ต้องแก้ไขกระบวนการ)<br>
          • สาเหตุ 1.2, 1.3, 1.4 = ยกเว้น ไม่นำมาคำนวณ<br>
          <strong>เหตุผล:</strong> วัดความสามารถจริงของทีม ไม่รวมปัจจัยภายนอกที่ควบคุมไม่ได้</p>
        </div>
        <div class="guide-rule">
          <b>🎯 FTR Rate (First-Time Right)</b>
          <p>ประสิทธิภาพในการส่งมอบงานที่ "ถูกต้องตั้งแต่ครั้งแรก" โดยไม่มีการตีกลับเพื่อแก้ไข<br>
          <strong>วิธีคิด:</strong> งานที่เสร็จสิ้นโดยไม่มี Revision และไม่ถูก Reject / จำนวนงานเสร็จสิ้นทั้งหมด<br>
          <strong>เป้าหมาย:</strong> &gt; 80%</p>
        </div>
        <div class="guide-rule">
          <b>🔄 Rework Rate</b>
          <p>% ของงานทั้งหมดที่มีการแก้ไข (นับทุกสาเหตุ 1.1-1.4) — ใช้ดูภาพรวมปริมาณการแก้ไข ไม่ใช่ตัวเดียวกับ Drawing Quality Score<br>
          <strong>เป้าหมาย:</strong> &lt; 20%</p>
        </div>
        <div class="guide-rule">
          <b>🚀 On-Time Delivery Rate</b>
          <p>% งานที่ส่งมอบตรงตามวันที่กำหนด<br>
          <strong>เป้าหมาย:</strong> &gt; 85%</p>
        </div>
        <div class="guide-rule">
          <b>⏱️ Avg Cycle Time</b>
          <p>ระยะเวลาเฉลี่ยตั้งแต่รับคำร้อง → เสร็จสิ้น (หน่วย: วัน)<br>
          <strong>เป้าหมาย:</strong> ลดลงต่อเนื่องทุกเดือน</p>
        </div>
        <div class="guide-rule">
          <b>💸 ต้นทุนโอกาส (Overdue Cost)</b>
          <p>คำนวณจาก OT 94 บาท/ชั่วโมง (ค่าแรงขั้นต่ำวิชาชีพเฉพาะ) × จำนวนวันที่เกินกำหนด × 8 ชั่วโมง/วัน<br>
          <strong>หมายเหตุ:</strong> เป็นการประมาณต้นทุนโอกาสขั้นต่ำ ไม่รวมค่าปรับล่าช้าจากลูกค้า</p>
        </div>
        <div class="guide-rule">
          <b>🚫 Cancellation Rate & Wasted Cost</b>
          <p><strong>Cancellation Rate:</strong> % งานที่ถูกยกเลิก = (จำนวนยกเลิก ÷ ทั้งหมด) × 100<br>
          <strong>Wasted Cost:</strong> 4 ชม. × 62.5 บาท × จำนวนงานที่ยกเลิก (ต้นทุนงานที่ทำไปแล้วก่อนยกเลิก)<br>
          <strong>จำแนกสาเหตุ:</strong>
          <ul style="margin:6px 0 0 16px;font-size:12px;">
            <li><b>1.1 ฝ่ายเขียนแบบ</b> — กระทบ KPI คุณภาพโดยตรง</li>
            <li><b>1.2 ผู้ส่งคำร้อง</b> — ไม่กระทบ KPI · ใช้ปรับปรุงระบบสั่งงาน</li>
            <li><b>1.3 งานติดตั้ง</b> — ไม่กระทบ KPI · ใช้ปรับปรุงความแม่นยำหน้างาน</li>
            <li><b>1.4 ลูกค้า</b> — ไม่กระทบ KPI · เป็นปัจจัยความเสี่ยงธุรกิจ</li>
          </ul>
          <strong>แสดงผล:</strong> Donut Chart สัดส่วนสาเหตุ + Bar Chart ต้นทุนที่เสียเปล่าแยกตามสาเหตุ
          </p>
        </div>
          <p>สัดส่วนงานที่ติดขัดจากสาเหตุ 1.2, 1.3, 1.4 ใช้เป็นหลักฐานนำเสนอผู้บริหารว่า "ปัญหาคอขวดอยู่ที่ใด"<br>
          <strong>ประโยชน์:</strong> แสดงให้เห็นว่างานล่าช้าไม่ใช่ความผิดของฝ่ายเขียนแบบเสมอไป</p>
        </div>
      </div>
    </section>
  `;
  ...
  return `
    <section class="guide-section" id="guide-tips">
      ...
      <div class="guide-tips-grid">
        ...
        ${tip("เลือกประเภทงานก่อนเสมอ", "หน้าส่งคำร้องบังคับให้เลือกประเภทงานก่อน (Proposal / ขออนุญาต / ก่อสร้าง / As-Built / อื่นๆ) — ช่องโครงการและ Drawing จะปรากฏขึ้นมาให้กรอกหลังเลือกประเภทงานแล้วเท่านั้น ป้องกันการส่งคำร้องผิดประเภท")}
        ${tip("แนบไฟล์ได้ทุกประเภท", "ตอนส่งงานให้ผู้จัดการตรวจ แนบได้ทั้ง DWG, PDF, รูปภาพ, Word, Excel, ZIP ฯลฯ — ไฟล์ทุกประเภทจะขึ้นเป็นปุ่มให้ผู้จัดการกดเปิดได้ทันทีในหน้าตรวจสอบ ไม่ต้องเข้า SharePoint เอง")}
        ${tip("สถานะอัปเดต real-time", "หน้าติดตามงานและหน้ารับงาน/อนุมัติ จะอัปเดตสถานะอัตโนมัติทุก 10 วินาที และทันทีเมื่อกลับมาที่แท็บ — ไม่จำเป็นต้องกด refresh เอง และถ้ากำลังกรอกฟอร์มอยู่ระบบจะไม่ interrupt การทำงาน")}
      </div>
    </section>
  `;
}
