    ...
    if (extraRow) {
      ...
      extraRow.innerHTML = `
        ...
        <div style="background:#fff;border-radius:12px;padding:16px 18px;border:1px solid #E2E8F0;box-shadow:0 2px 6px rgba(0,0,0,0.06);display:flex;flex-direction:column;gap:5px;">
          ...
          <div style="font-size:16px;font-weight:800;color:#7C3AED;line-height:1.2;">${escapeHtml(topWorkload.name.split(" ")[0])}</div>
          <div style="font-size:10px;color:#94A3B8;">${topWorkload.count} งาน · ${topWorkload.urgent} ด่วน</div>
        </div>
