...
function mBar(label, pct, color, right) {
  return `<div style="display:grid;grid-template-columns:160px 1fr 60px;align-items:center;gap:8px;margin-bottom:8px;">
...
export function renderKpiDashboard(allRequests, team, period, person = null, customRange = null) {
  ...
  const qualityScoreRows  = measurable.map((r) => {
    if (r.revisionSource !== "1.1") return 100;
  ...
  return `
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
      ...
      ${pBox(`🏆 Drawing Quality Score <span style="font-size:11px;font-weight:400;color:#94A3B8;margin-left:6px;">วัดจากสาเหตุ 1.1 เท่านั้น</span>`, `
        <div style="display:flex;align-items:center;gap:20px;margin-bottom:14px;">
          <div style="text-align:center;">
            <div style="font-size:48px;font-weight:900;color:${qualityScore>=80?"#0DB14B":qualityScore>=60?"#F59E0B":"#EF4444"};line-height:1;">${qualityScore}</div>
            <div style="font-size:12px;color:#64748B;">/ 100 คะแนน</div>
          </div>
          <div style="flex:1;">
            <div style="background:#F1F5F9;border-radius:8px;height:18px;overflow:hidden;margin-bottom:8px;">
            ...
            <div style="font-size:11px;color:#64748B;line-height:1.8;">
              📌 วัดจากงาน <b>สาเหตุ 1.1 (ฝ่ายเขียนแบบ)</b> เท่านั้น<br>
              • แก้ไข &lt; 4 ครั้ง = 100 คะแนน<br>
              • แก้ไข ≥ 4 ครั้ง = 20 คะแนน<br>
              • สาเหตุ 1.2, 1.3, 1.4 = ยกเว้น (Excluded)
            </div>
          </div>
        </div>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;">
              <thead>
                <tr style="background:#FFF1F2;">
                  ...
                  <th style="padding:6px 8px;text-align:center;color:#991B1B;font-weight:600;border-bottom:1px solid #FECACA;">%</th>
