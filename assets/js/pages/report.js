            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;">
              <thead>
                <tr style="background:#FFF1F2;">
                  ...
                  <th style="padding:6px 6px;text-align:center;color:#991B1B;font-weight:600;border-bottom:1px solid #FECACA;">ล่าช้าเฉลี่ย</th>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        ...
        ${pBox(`🍩 สัดส่วนต้นเหตุการยกเลิก`, (() => {
          ...
          slices.forEach((sl) => {
            ...
            const sAngle = toRad(cumPct * 3.6), eAngle = toRad((cumPct + pct) * 3.6);
